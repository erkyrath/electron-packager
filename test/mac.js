...
function createExtraResourceTest () {
  return function (t) {
    t.timeoutAfter(config.timeout)
...
function createExtraResource2Test () {
  return function (t) {
    t.timeoutAfter(config.timeout)
...
function createExtendInfoTest (extraPath) {
  return function (t) {
    t.timeoutAfter(config.timeout)
...
util.setup()
test('extend-info test', createExtendInfoTest(extraInfoPath))
util.teardown()

util.setup()
test('extra-resource test: one arg', createExtraResourceTest())
util.teardown()

util.setup()
test('extra-resource test: two arg', createExtraResource2Test())
util.teardown()
